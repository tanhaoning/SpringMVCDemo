$(document).ready(function () {
    ...
    function switch_theme(theme_name) {
        $('#bs-css').attr('href', contextPath + '/css/bootstrap/bootstrap-' + theme_name + '.css');
    }
...
function docReady() {
    ...
    $('#loginId').off("click").on("click", function () {
        window.location.href = contextPath + "/test/redirectNewPage";
        //window.open(contextPath+'/test/redirectNewPage','top');
    });
